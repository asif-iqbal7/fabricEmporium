...
<section id="products" class="products mt-5">
    <h2 class="section-head text-center text-uppercase mt-2"><a href="#">BEST SALLERS</a></h2>
<div class="d-flex justify-content-around mt-2 flex-wrap">
    <?php
        $select_saller="SELECT * FROM `product`  LEFT JOIN `brands` ON product.pro_brand = brands.b_id WHERE saller_status = 1 LIMIT 16";
